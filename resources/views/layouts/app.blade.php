            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/inscripciongrp') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Inscripciongrp</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/inscripcionidv') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Inscripcionidv</a> 
                        </li>
						<li class="nav-item">
						...
						<li class="nav-item">
                            <a href="{{ url('/categoriajuegos') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Categoriajuegos</a> 
                        </li>
						<li class="nav-item">
