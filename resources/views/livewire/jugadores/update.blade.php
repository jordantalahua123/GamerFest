            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="equipos_id" type="text" class="form-control" id="equipos_id"
                            placeholder="Equipos Id">@error('equipos_id') <span
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="telefono" type="text" class="form-control" id="telefono"
                            placeholder="Telefono">@error('telefono') <span
                            class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
