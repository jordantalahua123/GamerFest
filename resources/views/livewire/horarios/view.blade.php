                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div>
                                <input wire:model='keyWord' type="text" class="form-control" name="search"
                                    id="search" placeholder="Buscar Horarios">
                            </div>
                            <div>
								<a href="{{ route('view-pdf') }}" target="__blank">
                                <div class="btn btn-sm btn-info" data-toggle="modal">
                                    <i class="fas fa-download p-1"></i> Exportar PDF
                                </div>
							</a>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item"
                                                            onclick="confirm('Confirm Delete Horario id {{ $row->id }}? \nDeleted Horarios cannot be recovered!')||event.stopImmediatePropagation()"
